...
#include "Windows/Graphs/NewGraphWindow.h"
...
std::shared_ptr<Window> DevicePanel::getOrCreateWindow(const juce::ValueTree& windowTree)
{
    ...
    {
        return window = std::make_shared<NewGraphWindow>(windowLayout, windowTree.getType(), *this, glRenderer, std::vector<juce::String> { "X", "Y", "Z" }, std::vector<juce::Colour> { UIColours::graphRed, UIColours::graphGreen, UIColours::graphBlue });
    }
