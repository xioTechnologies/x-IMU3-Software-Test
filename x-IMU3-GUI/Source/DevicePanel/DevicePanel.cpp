...
#include "Windows/NewGraphs/NewGyroscopeGraphWindow.h"
...
std::shared_ptr<Window> DevicePanel::getOrCreateWindow(const juce::ValueTree& windowTree)
{
    ...
    {
        return window = std::make_shared<NewGyroscopeGraphWindow>(windowLayout, windowTree.getType(), *this, glRenderer);
    }
