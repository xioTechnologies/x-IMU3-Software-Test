...
#include "Windows/Graphs/SerialAccessoryGraphWindow.h"
...
std::shared_ptr<Window> DevicePanel::getOrCreateWindow(const juce::ValueTree& windowTree)
{
    ...
    if (type == WindowIDs::SerialAccessory)
    {
        return window = std::make_shared<SerialAccessoryGraphWindow>(windowLayout, type, *this, glRenderer);
    }
