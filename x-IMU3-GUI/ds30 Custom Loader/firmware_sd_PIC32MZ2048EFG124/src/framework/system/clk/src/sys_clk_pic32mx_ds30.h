/*******************************************************************************
  ...
  Summary:
    Clock System service definitions and declarations specific to MX support

  Description:
    This file contains the Clock System Service fucntions and definitions that 
	are specific to the MX chip set family.
*******************************************************************************/
...
#ifndef _SYS_CLK_PIC32MX_H
#define _SYS_CLK_PIC32MX_H
